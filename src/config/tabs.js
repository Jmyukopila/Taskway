import { HoyIcon, HoyIconActive, CalendarioIcon, CalendarioIconActive, HabitosIcon, HabitosIconActive, HorarioIcon, HorarioIconActive, TareasIcon, TareasIconActive, AcademicoIcon, AcademicoIconActive } from './icons'
...
export const TABS = [
  ...
  { key: 'academico', label: 'Académico', icon: AcademicoIcon, iconActive: AcademicoIconActive }
]
